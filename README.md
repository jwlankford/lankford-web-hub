...
*   [main.py](file:///d:/lankford-web-hub/backend/main.py): Entry point of the FastAPI application. Sets up CORS, parses incoming headers via middleware to isolate tenant database requests, and defines routing for papers, notebooks, mailing list signups, and articles.
*   [models.py](file:///d:/lankford-web-hub/backend/models.py): SQLModel schemas defining database structures for research papers, notebook references, mailing list entries, and articles.
